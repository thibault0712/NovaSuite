...
import { MdOutlineDriveFileRenameOutline, MdDelete, MdAdd, MdHome, MdFolder, MdFolderShared, MdNoteAdd, MdAddCircleOutline } from 'react-icons/md';
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 h-screen ">
      ...
      <div className='flex w-full'>
        <div className='bg-white fixed top-75 z-50 w-16 dark:bg-gray-900 h-full border-r border-r-slate-700/50 dark:border-r-slate-500/30' style={{ height: 'calc(100vh - 75px)' }}>
          ...
          <Link className='p-2 py-3 hover:bg-gray-200 hover:dark:bg-gray-800/40 text-center flex justify-center text-slate-600 dark:text-slate-300 hover:text-blue-700 dark:hover:text-purple-700'>
            <div className='w-full mx-auto'>
          ...
          <Link className='p-2 py-3 hover:bg-gray-200 hover:dark:bg-gray-800/40 text-center flex justify-center text-slate-600 dark:text-slate-300 hover:text-blue-700 dark:hover:text-purple-700'>
            <div className='w-full mx-auto'>
              ...
              <span className=' font-medium' style={{fontSize: 12}}>Partagé</span>
            </div>
          </Link>
        </div>
        <div className="py-4 px-5 ml-16 w-full border-t border-t-slate-700/50 dark:border-t-slate-500/30">
              ...
              >
                ...
                >
                  {close => (
                    ...
                    <div className="modal bg-slate-700 rounded-xl pb-4 mx-4 my-6 shadow-md overflow-y-auto scrollbar-thin scrollbar-track-slate-700/0 scrollbar-thumb-slate-900/50" style={{ width: '85vw', maxWidth: '600px', maxHeight: '85vh' }}>
                      <div className="mb-3 text-center text-xl py-3 font-bold text-white bg-slate-700 sticky top-0 z-10">Êtes-vous sûr de vouloir supprimer {element.data.title} ?</div>

                      <div className="pt-4 flex justify-end mr-5">
                        <div style={{margin: '0 auto'}}>
                            <button onClick={() => close()} className="bg-green-500 w-30 text-white font-bold py-2 px-4 rounded mr-5">Annuler</button>
                            <button onClick={() => {HandlleRemoveElement(element.id, elements, setElements); close()}} className="bg-red-500 w-30 text-white font-bold py-2 px-4 rounded">Confirmer</button>
                        </div>
                      </div>
                    </div>
                  )}
