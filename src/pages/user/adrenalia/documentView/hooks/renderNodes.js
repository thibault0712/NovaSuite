...
export function RenderNodes(nodes, objectives, documents, selectedDocument, blockedNodes, element, userData) {
    return nodes
        ...
        .map((node, i) => {
            ...
            <div key={i} >
                {i % 2 === 0 && (
                <div className='bg-gray-100 dark:bg-gray-900 overflow-x-auto min-w-full'>
                    ...
                    <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-slate-700/50 scrollbar-track-slate-500/0">
                        <div className="my-5 flex ">
                            ...
                            objectives[i]?.filter(objective => objective.parents.length === 0)
                                ...
                                .map(objective => {
                                        return RenderObjectives(node, objective, 0, i, "bg-gray-200 dark:bg-gray-900", objectives, documents, selectedDocument, blockedNodes, element, userData);
                                })
                            }
                        </div>
                    </div>
                ...
                {i % 2 !== 0 && (
                <div className='bg-gray-200  dark:bg-gray-900 overflow-auto min-w-full scrollbar-none'>
                    ...
                    <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-slate-700/50 scrollbar-track-slate-500/0">
                        <div className="my-5 flex ">
                            ...
                            objectives[i]?.filter(objective => objective.parents.length === 0)
                                ...
                                .map(objective => {
                                    try {
                                        return RenderObjectives(node, objective, 0, i, "bg-gray-50 dark:bg-gray-900", objectives, documents, selectedDocument, blockedNodes, element, userData);
                                    }catch(e) {
                                        return(e)
                                    }
                                })
